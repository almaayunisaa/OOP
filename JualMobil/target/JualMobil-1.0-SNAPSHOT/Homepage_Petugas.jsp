                            ...
                            <div class="modal-body">
                                <div class="row mb-3">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control"  id="modalId" name="modalId" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Nama Mobil</label>
                                        <input type="text" class="form-control"   id="modalNama" name="modalNama" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Type</label>
                                        <input type="text" class="form-control"   id="modalTipe" name="modalTipe" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Warna Mobil</label>
                                        <input type="text" class="form-control"   id="modalWarna" name="modalWarna" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Plat Nomor</label>
                                        <input type="text" class="form-control"   id="modalPlat" name="modalPlat" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Odometer</label>
                                        <input type="text" class="form-control"   id="modalOdo" name="modalOdo" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Kapasitas Mesin</label>
                                        <input type="text" class="form-control"   id="modalKapasitas" name="modalKapasitas" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Ketersediaan</label>
                                        <input type="text" class="form-control"   id="modalKetersediaan" name="modalKetersediaan" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Nomor Rangka</label>
                                        <input type="text" class="form-control"   id="modalRangka" name="modalRangka" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Nomor Mesin</label>
                                        <input type="text" class="form-control"   id="modalMesin" name="modalMesin" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                    <div class="col">
                                        <label for="exampleFormControlTextarea1" class="form-label">Harga</label>
                                        <input type="text" class="form-control"   id="modalHarga" name="modalHarga" aria-label="Disabled input example" disabled readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            document.querySelectorAll(".card").forEach(card => {
                card.addEventListener("click", () => {
                    ...
                    modalInputs.nama.value = card.getAttribute("data-nama").trim();
